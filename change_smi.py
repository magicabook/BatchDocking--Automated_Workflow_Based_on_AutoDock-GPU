...
if smi_err_number + smi_war_number == 0: # 判断异常计数是否为0
    print(f'\033[92m\n    {lang_smi_summary_suc1}{smi_number}{lang_smi_summary_suc2}\033[0m') # 输出无异常结束语句
else: # 若异常计数器不为零，则将异常输出计数打印并调用异常提示信息
    print(f'\033[91m\n{lang_smi_summary_failure1}{smi_number}{lang_smi_summary_failure2}{smi_err_number}{lang_smi_summary_failure3}{smi_war_number}{lang_smi_summary_failure4}\033[0m')