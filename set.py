...
def set():
    ...
    while True:
        ...
        print(f'\n\033[92m    {lang_inter_suc.format(globals().get(set_select_out))}\n\033[0m')  # 打印选择结果
        ...
        if set_function_number == '1':
            lang_list_raw = os.listdir('./language')
            ...
            while set_lang not in lang_list:  # 检查输入的选择是否合法
                try:
                    ...
                    print(f'    \033[93m{lang_inter_function_err}\033[0m')
            # 打开配置文件
            with open('properties.py', 'r') as properties_data:
            ...
            # 保存修改
            with open('properties.py', 'w') as properties_data:
        ...
        # 设置单次对接迭代次数
            ...
            while True:
                ...
                if (is_integer(set_nrun)) == True:
                    ...
                    print(f'    \033[93m{lang_inter_set_nrun_war}\033[0m')
                elif len(set_nrun) == 0:
                    print(f'    \033[93m{lang_inter_set_nrun_none}\033[0m')
            # 替换文件内容
            new_run = set_nrun
            # 查询并修改
        ...
        #设置对接程序运行种子
            ...
            while True:
                ...
                if set_seed == '':
                    ...
                    print(f'\n    \033[93m{lang_inter_set_seed_war}\n\033[0m')
            # 替换文件内容
            new_seed = set_seed
            # 查询并修改
